        ...
        <details>
          ...
          <div className="layout-control-body">
            ...
            <label>
              ...
              <input defaultValue={SITE_CONTENT.features.titleLine1} onInput={(event) => changeText(() => { SITE_CONTENT.features.titleLine1 = event.currentTarget.value; })} />
            </label>
            <label>
              <span>Title line 2</span>
              <input defaultValue={SITE_CONTENT.features.titleLine2} onInput={(event) => changeText(() => { SITE_CONTENT.features.titleLine2 = event.currentTarget.value; })} />
            </label>
            {SITE_CONTENT.features.items.map((item, index) => (
              <fieldset key={`feature-${index}`}>
                ...
                <label>
                  ...
                  <input defaultValue={item.title} onInput={(event) => changeText(() => { item.title = event.currentTarget.value; })} />
                </label>
                <label>
                  <span>Description</span>
                  <textarea rows={3} defaultValue={item.description} onInput={(event) => changeText(() => { item.description = event.currentTarget.value; })} />
                </label>
        ...
        <details>
          ...
          <div className="layout-control-body">
            ...
            <label>
              ...
              <textarea rows={3} defaultValue={SITE_CONTENT.faq.title} onInput={(event) => changeText(() => { SITE_CONTENT.faq.title = event.currentTarget.value; })} />
            </label>
            {SITE_CONTENT.faq.items.map((item, index) => (
              <fieldset key={`faq-${index}`}>
                ...
                <label>
                  <span>Question</span>
                  <textarea rows={2} defaultValue={item.question} onInput={(event) => changeText(() => { item.question = event.currentTarget.value; })} />
                </label>
                <label>
                  <span>Answer</span>
                  <textarea rows={4} defaultValue={item.answer} onInput={(event) => changeText(() => { item.answer = event.currentTarget.value; })} />
                </label>
