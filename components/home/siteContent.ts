...
export const SITE_CONTENT: SiteContentConfig = {
  ...
  faq: {
    ...
    items: [
      {
        question: "تامین کالا چقدر سریع اتفاق میفته؟",
        answer: "هونامیک ارتباط رستاک توسط ارتباطات گسترده‌ای که تو کشورمون داره هر کالای خاصی که سازمان شما به اون نیاز داره به همراه مشاوره و نصب تا نهایتا 24 ساعت برای شما تامین و نصب میکنه."
      },
      {
        question: "پشتیبانی و مانیتورینگ سلامت تجهیزات چطور اتفاق میفته؟",
        answer: "کارشناسان فنی هونامیک ارتباط رستاک به صورت مدوام سلامت عملکرد محصولات و راه‌کار رو پایش میکنن و همچنین به صورت ماهانه از سازمان شما بازدید خواهند داشت."
      },
      {
        question: "اگه نقصی برای محصول پیش بیاد چی میشه؟",
        answer: "در صورت رویت هرگونه نقص که متوجه محصول یا راه‌کار باشه متخصصین فنی تا رفع نقص سیستم در کنار شما خواهند بود."
      },
      {
        question: "تفاوت هونامیک ارتباط رستاک با رقبا چیه؟!",
        answer: "هونامیک ارتباط رستاک با افتخار تنها وارد کننده محصولاتی خاص در زمینه زیرساخت و ذخیره‌سازی داده است و با مجرب‌ترین کارشناسان فنی محیطی رو برای آسایش سازمان‌ها در رابطه با ذخیره‌سازی داده فراهم کرده است."
      }
    ]
  },
  cta: {
